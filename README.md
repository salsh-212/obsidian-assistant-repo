...
> A personal knowledge assistant that uses Claude Code to query a local Obsidian vault and log structured answers into Notion.
...
| Tool | Purpose |
|------|---------|
| **Claude Code** | AI engine and workflow builder |
| **Obsidian** | Local markdown knowledge base |
| **Notion** | Answer logging and knowledge record |
...
🔨 **In progress** — building and learning in public.
